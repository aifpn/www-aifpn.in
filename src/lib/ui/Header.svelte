...
<header class="{styles}">
    ...
    <div class="relative w-full h-32 sm:h-40 md:h-44 flex-cij">
        ...
        <div class="sm:absolute top-0 right-0 text-white flex-rij">
            ...
            <button
                type="button"
                class="sm:hidden px-4 py-2 m-1 text-center text-sm font-medium rounded-lg cursor-pointer bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:ring-blue-300"
